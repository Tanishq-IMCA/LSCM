...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-6 pt-12 pb-8"
      ...
      {/* Preview-only auth gate: keep the real sign-in UI underneath while
          making it clear that the identity service is intentionally offline. */}
      <AnimatePresence>
        {showComingSoon && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            style={{ background: 'rgba(2, 4, 12, 0.76)', backdropFilter: 'blur(14px)' }}
          >
            <motion.div
              ...
              className="relative w-full max-w-md border border-white/[0.12] bg-white/[0.06] p-8 shadow-2xl"
            ...
            >
              ...
              <h2
                className="text-2xl uppercase tracking-[0.12em] text-white"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                Authentication coming soon.
              </h2>
              <p
                className="mt-4 text-sm leading-7 text-white/45"
                style={{ fontFamily: 'var(--font-body)' }}
              >
                The RepoSight workspace is ready for preview. Live identity services
                are being wired separately, so you can explore the sign-in screen
              ...
              <div className="mt-7 flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="px-5 py-3 text-[10px] uppercase tracking-[0.24em] text-black transition-opacity hover:opacity-90"
                  style={{ backgroundColor: 'var(--accent)', fontFamily: 'var(--font-display)' }}
                >
                  Preview sign in
                </button>
              </div>

...
const sections = [
  ...
  ['Heist & Gameplay Guidelines', 'Heist slots are shared live in Discord. Premium heists are limited to two runs per 20 minutes. Current scheduled availability is Monday–Friday, 9am–3pm CST, with Thursday reserved for modded car requests. Follow community earning limits and cooldowns.'],

...
export default function AdminHomePage() {
  return (
    <main className="min-h-screen pt-24">
      <Header />
      <section className="mx-auto max-w-[1700px] px-6 py-16 md:px-10 xl:px-14">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          ...
          <Link href="/admin/products" className="glass-panel relative h-fit self-start overflow-hidden p-8 transition hover:border-[var(--accent)]/40 hover:bg-white/[0.06]">
            ...
            <div className="relative z-10 md:flex md:items-start md:justify-between md:gap-10">
              <div className="max-w-xl">
                ...
                <p className="mt-4 text-sm leading-7 text-white/40">Create, edit and delete products across services, vehicles, outfits and future store pages.</p>
                <p className="mt-3 text-sm leading-7 text-white/35">Listings publish directly into the selected storefront collection.</p>
              </div>
              <div className="mt-7 shrink-0 border border-[var(--accent)]/35 bg-[var(--accent)]/[0.06] px-5 py-4 md:mt-0">
                ...
                <p className="mt-2 text-xl uppercase tracking-[0.12em] text-white">Live</p>
